    ...
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden z-10">
      <div className="max-w-6xl mx-auto text-center space-y-8">
        ...
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-panel border border-cyan-500/30 text-xs sm:text-sm font-mono text-cyan-300 shadow-neon-cyan"
        >
          <Zap className="w-4 h-4 text-cyan-400 animate-pulse" />
          <span>Full-Stack Engineering & High-Performance 3D Web Systems</span>
        </motion.div>
        ...
        >
          <a
            href="#capabilities"
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-primary via-indigo-600 to-accent-cyan text-white font-semibold text-sm sm:text-base flex items-center justify-center space-x-3 shadow-lg shadow-primary/30 hover:shadow-neon-indigo transition-all transform hover:-translate-y-0.5"
          >
        ...
        >
          {[
            ...
            return (
              <div
                key={idx}
                className="glass-card p-4 rounded-2xl flex flex-col items-center justify-center text-center space-y-1.5 border border-white/5 hover:border-cyan-500/30 transition-all"
              >
